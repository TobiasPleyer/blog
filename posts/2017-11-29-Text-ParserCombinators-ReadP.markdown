...
Next up is *P*. Nowhere in the documentation of the source it is
...
We can try to express the meaning of these definitions. The *bind*
...
The *run* function knows how to handle the primitive parser
